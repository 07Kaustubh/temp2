...
void MX_GPIO_Init(void)
{
	...
	/**/
	LL_GPIO_SetOutputPin(GPIOA, SPI1_CS_Pin|SPI3_CS_Pin);

	/**/
	LL_GPIO_ResetOutputPin(GPIOA, LL_GPIO_PIN_2);

	/**/
	LL_GPIO_ResetOutputPin(GPIOB, LL_GPIO_PIN_10|LL_GPIO_PIN_14|LED_GPS_Pin
...
//#ifdef V2
	/* DOUT1 , DOUT2 Is Initialize Here */
...
////	LL_GPIO_ResetOutputPin(GPIOB, ON_OFF_3_3_Pin);//ON_OFF_3_3_PIN
//	LL_GPIO_ResetOutputPin(GPIOB, ON_OFF_3_3_Pin);
//
//	GPIO_InitStruct.Pin = ON_OFF_3_3_Pin;
//	GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
//	GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
//	GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
//	GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
...
//#endif
	...
	/*	DIN1,DIN2 is pin initialize here */
	...
	/**/
	GPIO_InitStruct.Pin = LL_GPIO_PIN_2|SPI1_CS_Pin;
	GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
	GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
	GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
	GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
	...
	/**/
	GPIO_InitStruct.Pin = LL_GPIO_PIN_10|LL_GPIO_PIN_14|LED_GPS_Pin
			|LL_GPIO_PIN_7|LL_GPIO_PIN_8;
	GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
	GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
	GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
